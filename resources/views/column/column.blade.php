...
@section('title', 'コラム | ゲーム実況で儲かるプラットフォームをお探しならライブ配信 - ')
@section('content')
...
<h3>ゲーム実況が可能な儲かるプラットフォームをお探しならB-LIVE</h3>
<table>
<tbody>
<tr>
<th>会社名</th>
...
@push('meta')
    <meta name="description" content="ゲーム実況で儲かるプラットフォーム・おすすめアプリならB-LIVEをご利用ください。配信方法も簡単なライブ配信プラットフォームです！ゲーム実況で儲かるには、収益化して稼ぐことができるプラットフォームを選ぶことが大切です。">
...
@push('scripts')
    ...
    <script type="text/javascript">
        jQuery(function($) {
            $('meta[name=description]').attr({content: 'ゲーム実況で儲かるプラットフォーム・おすすめアプリならB-LIVEをご利用ください。配信方法も簡単なライブ配信プラットフォームです！ゲーム実況で儲かるには、収益化して稼ぐことができるプラットフォームを選ぶことが大切です。'});
