...
<head>
    ...
    <link href="{{ mix('css/fonts.css') }}?param=89" rel="stylesheet">
    <link href="{{ mix('css/app.css') }}?param=89" rel="stylesheet">
    <link href="{{ mix('css/all.css') }}?param=89" rel="stylesheet">
    @if (Request::is('/'))
...
<body>
    ...
    <script src="{{ mix('js/app.js') }}?param=89"></script>
    <script src="{{ mix('js/all.js') }}?param=89"></script>
    <script src="{{ mix('js/common.js') }}?param=89"></script>
    @stack('scripts')
</body>
</html>
