...
<head>
    ...
    <link href="{{ mix('css/app.css') }}?param=68" rel="stylesheet">
    <link href="{{ mix('css/all.css') }}?param=68" rel="stylesheet">
    @if (Request::is('/'))
...
<body>
    ...
    <script src="{{ mix('js/app.js') }}?param=68"></script>
    <script src="{{ mix('js/all.js') }}?param=68"></script>
    <script src="{{ mix('js/common.js') }}?param=68"></script>
    @stack('scripts')
</body>
</html>
