...
<head>
    ...
    <link href="{{ mix('css/fonts.css') }}?param=61" rel="stylesheet">
...
<body>
    ...
    <script src="{{ mix('js/app.js') }}?param=61"></script>
    <script src="{{ mix('js/all.js') }}?param=61"></script>
    <script src="{{ mix('js/common.js') }}?param=61"></script>
    @stack('scripts')
</body>
</html>
