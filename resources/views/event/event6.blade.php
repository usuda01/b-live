...
<head>
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event6/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="1万円獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event6/ogp-event.png" />
    ...
    <title>イベント第６弾！1万円獲得イベント｜B-LIVE</title>
</head>
<body>
    ...
    <div id="app">
        <div class="event-event6">
            <div class="fv">
                <img src="/images/event6/fv.jpg">
            </div>

            @if (Config::get('services.event6.start_date') > date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※イベント開始までお待ちください
                </div>
            @endif

            @if (Config::get('services.event6.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif
            ...
            <div class="event-detail">
                ...
                <div class="detail">
                    ...
                    <div>
                        <p>▼イベント期間</p>
                        <p>2022/7/13(水) 0時 ～ 2022/7/20(水) 23:59:59</p>
                    </div>
                    <div>
                        <p>▼参加方法</p>
