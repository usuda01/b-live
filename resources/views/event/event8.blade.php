...
<head>
    ...
    <meta name="description" content="ショート動画を投稿していいね数１位を目指そう！">
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event8/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="1万円獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event8/ogp-event.png" />
    <meta name="twitter:description" content="ショート動画を投稿していいね数１位を目指そう！" />
    <link rel="apple-touch-icon" href="/images/apple-touch-icon.png" />
    <link href="{{ mix('css/fonts.css') }}" rel="stylesheet">
    <link href="{{ mix('css/app.css') }}?param=61" rel="stylesheet">
    <link href="{{ mix('css/all.css') }}?param=61" rel="stylesheet">
    <title>イベント第８弾！1万円獲得イベント｜B-LIVE</title>
</head>
<body>
    ...
    <div id="app">
        <div class="event-event8">
            <div class="fv">
                <img src="/images/event8/fv.jpg">
            </div>

            @if (Config::get('services.event8.start_date') > date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※イベント開始までお待ちください
                </div>
            @endif

            @if (Config::get('services.event8.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif
            ...
            <div class="event-detail">
                ...
                <div class="detail">
                    ...
                    <div>
                        <p>▼参加方法</p>
                        <p>① <a class="twitter" href="https://twitter.com/BLIVE77191685/status/1566795566205399040" target="_blank">この投稿</a>をリツイート＆フォロー</p>
            ...
            <div class="event-howto">
                ...
                <div class="notice">スマホからも投稿可能です。</div>
                <div class="detail">
                    <ul>
            ...
            <div class="event-caution">
                ...
                <ul class="note">
                    ...
                    <li>※いいね数が同じ場合、先に投稿された動画が優先されます。</li>
                </ul>
            </div>
