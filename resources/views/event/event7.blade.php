...
<head>
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event7/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="1万円獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event7/ogp-event.png" />
    ...
    <title>イベント第７弾！1万円獲得イベント｜B-LIVE</title>
</head>
<body>
    ...
    <div id="app">
        <div class="event-event7">
            <div class="fv">
                <img src="/images/event7/fv.jpg">
            </div>

            @if (Config::get('services.event7.start_date') > date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※イベント開始までお待ちください
                </div>
            @endif

            @if (Config::get('services.event7.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif
