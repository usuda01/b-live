...
<head>
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event4/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="1万円獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event4/ogp-event.png" />
...
<body>
    ...
    <div id="app">
        <div class="event-event4">
            <div class="fv">
                <img src="/images/event4/fv.jpg">
            </div>

            @if (Config::get('services.event4.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif

            @if (Config::get('services.event4.start_date') < date('Y-m-d H:i:s'))
                <div class="ranking">
            ...
            <div class="event-detail">
                ...
                <div class="detail">
                    ...
                    <div>▼イベント期間<br>2022/06/14(火) 0時 ～ 2022/06/24(金) 0時</div>
