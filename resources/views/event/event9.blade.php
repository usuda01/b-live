...
<head>
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event9/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="1万円獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event9/ogp-event.png" />
    ...
    <title>イベント第９弾！1万円獲得イベント｜B-LIVE</title>
    {{-- socket io --}}
...
<body>
    ...
    <div id="app">
        <div class="event-event9">
            <div class="fv">
                <img src="/images/event9/fv.jpg">
            </div>

            @if (Config::get('services.event9.start_date') > date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※イベント開始までお待ちください
                </div>
            @endif

            @if (Config::get('services.event9.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif
            ...
            <div class="event-detail">
                ...
                <div class="detail">
                    ...
                    <div>
                        <p>▼参加方法</p>
                        <p>① <a class="twitter" href="https://twitter.com/BLIVE77191685/status/1605746791462637569" target="_blank">この投稿</a>をリツイート＆フォロー</p>
                        <p>② B-LIVEにて配信</p>
                    </div>
                </div>
            </div>
