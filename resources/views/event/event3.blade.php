...
<head>
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event3/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="1万円獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event3/ogp-event.png" />
...
<body>
    ...
    <div id="app">
        <div class="event-event3">
            <div class="fv">
                <img src="/images/event3/fv.jpg">
            </div>

            @if (Config::get('services.event3.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif

            @if (Config::get('services.event3.start_date') < date('Y-m-d H:i:s'))
                <div class="ranking">
            ...
            <div class="event-detail">
                ...
                <div class="detail">
                    ...
                    <div>▼イベント期間<br>2022/06/04(土) 0時 ～ 2022/06/06(月) 0時</div>
                    <div>▼参加方法<br>①<a class="twitter" href="https://twitter.com/BLIVE77191685/status/1532743880927752192" target="_blank">この投稿</a>をリツイート＆フォロー<br>②B-LIVEにて、ショート動画を投稿</div>
            ...
            <div class="event-caution">
                ...
                <ul class="note">
                    <li>※イベント期間外にアップロードした動画はランキングの対象外となります。</li>
