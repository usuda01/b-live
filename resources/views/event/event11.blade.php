...
<head>
    ...
    <meta name="description" content="コメント数を競おう！">
    <meta property="og:title" content="アマギフ獲得イベント｜B-LIVE" />
    <meta property="og:description" content="コメント数を競おう！" />
    <meta property="og:url" content="{{ Request::url() }}" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event11/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="アマギフ獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event11/ogp-event.png" />
...
<body>
    ...
    <div id="app">
        <div class="event-event11">
            <div class="fv">
                <img src="/images/event11/fv.jpg">
            </div>

            @if (Config::get('services.event11.start_date') > date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※イベント開始までお待ちください
                </div>
            @endif

            @if (Config::get('services.event11.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif
                    ...
                    @foreach ($rooms as $room)
                        <div class="room-box">
                            ...
                            <div class="room-info">
                                ...
                                <div class="count">
                                    <span class="number">{{ $room->comment_count }}</span>
            ...
            <div class="event-detail">
                ...
                <div class="detail">
                    <div>
                        <p>▼ランキングについて</p>
                        <p>配信枠ごとにコメントをカウントします</p>
                        <p>自分とゲストコメントはカウントされません</p>
                        <p>同一ユーザーで複数配信がある場合、コメント数の多い方で計算します</p>
                    ...
                    <div>
                        <p>▼参加方法</p>
                        <p>① <a class="twitter" href="https://twitter.com/BLIVE77191685/status/1630925016505393152" target="_blank">この投稿</a>をリツイート＆フォロー</p>
                        <p>② B-LIVEにて配信</p>
                    </div>
                </div>
            </div>
            ...
            <div class="event-caution">
                ...
                <ul class="note">
                    ...
                    <li>※イベント終了後、 B-LIVEの公式Twitter（<a class="twitter" target="_blank" href="https://twitter.com/BLIVE77191685">@BLIVE77191685</a>）からDMを送ります。連絡をとれるようにしておいて下さい。</li>
                    <li>※メールアドレスでのギフトコード発送となります。</li>
                    <li>※常識的に不適切と思われる配信と判断した場合、イベントを辞退していただきます。</li>
                    <li>※BOTコメントはコメントを削除させていただく場合がございます。</li>
                    <li>※コメント数が同じ場合、後に配信された動画が優先されます。</li>
                </ul>
            </div>
    ...
    <script src="{{ mix('js/app.js') }}?param=88"></script>
    <script src="{{ mix('js/all.js') }}?param=88"></script>
    <script src="{{ mix('js/common.js') }}?param=88"></script>
</body>
</html>
