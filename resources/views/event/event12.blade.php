...
<head>
    ...
    <meta property="og:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event12/ogp-event.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="アマギフ獲得イベント｜B-LIVE" />
    <meta property="twitter:image" content="{{ Request::getSchemeAndHttpHost() }}/images/event12/ogp-event.png" />
    ...
    <title>イベント第１２弾！視聴時間を競おう！｜B-LIVE</title>
    {{-- socket io --}}
...
<body>
    ...
    <div id="app">
        <div class="event-event12">
            <div class="fv">
                <img src="/images/event12/fv.jpg">
            </div>

            @if (Config::get('services.event12.start_date') > date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※イベント開始までお待ちください
                </div>
            @endif

            @if (Config::get('services.event12.end_date') < date('Y-m-d H:i:s'))
                <div class="event-end">
                    ※このイベントは終了しました
                </div>
            @endif
